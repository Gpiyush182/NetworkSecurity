...
class DataValidation:
    ...
    def validate_numerical_columns(self, dataframe: pd.DataFrame) -> bool:
        try:
            required_columns = set(self._schema_config['numerical_columns'])
            dataframe_columns = set(dataframe.columns)
            # Check if all required numerical columns are present
            if required_columns.issubset(dataframe_columns):
                return True
            return False
        except Exception as e:
            raise NetworkSecurityException(e,sys)
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        try:
            ...
            data_validation_artifact = DataValidationArtifact(
                ...
                valid_train_file_path= self.data_ingestion_artifact.testing_file_path,
